...
public class TunableProfiledPIDController implements Sendable {
  private static int instances;

  private TunablePIDController m_controller;
  private double m_minimumInput;
  private double m_maximumInput;

  private TunableTrapezoidProfile.TunableConstraints m_constraints;
  private TunableTrapezoidProfile m_profile;
  private TunableTrapezoidProfile.State m_goal = new TunableTrapezoidProfile.State();
  private TunableTrapezoidProfile.State m_setpoint = new TunableTrapezoidProfile.State();
  ...
  public TunableProfiledPIDController(
      ...
      DoubleSupplier Ki,
      DoubleSupplier Kd,
      TunableTrapezoidProfile.TunableConstraints constraints) {
  ...
  public TunableProfiledPIDController(
      ...
      TunableTrapezoidProfile.TunableConstraints constraints,
      double period) {
    m_controller = new TunablePIDController(Kp, Ki, Kd, period);
    m_constraints = constraints;
    m_profile = new TunableTrapezoidProfile(m_constraints);
    instances++;
   ...
   */
  public void setGoal(TunableTrapezoidProfile.State goal) {
    m_goal = goal;
  }
  ...
  public void setGoal(double goal) {
    m_goal = new TunableTrapezoidProfile.State(goal, 0);
  }
   ...
   * @return The goal.
   */
  public TunableTrapezoidProfile.State getGoal() {
    return m_goal;
  }
   ...
   * @param constraints Velocity and acceleration constraints for goal.
   */
  public void setConstraints(TunableTrapezoidProfile.TunableConstraints constraints) {
    m_constraints = constraints;
    m_profile = new TunableTrapezoidProfile(m_constraints);
  }
   ...
   */
  public TunableTrapezoidProfile.TunableConstraints getConstraints() {
   ...
   */
  public TunableTrapezoidProfile.State getSetpoint() {
    return m_setpoint;
  }
   ...
   * @return The controller's next output.
   */
  public double calculate(double measurement, TunableTrapezoidProfile.State goal) {
    setGoal(goal);
  ...
  public double calculate(
      double measurement,
      TunableTrapezoidProfile.State goal,
      TunableTrapezoidProfile.TunableConstraints constraints) {
   ...
   */
  public void reset(TunableTrapezoidProfile.State measurement) {
    m_controller.reset();
  ...
  public void reset(double measuredPosition, double measuredVelocity) {
    reset(new TunableTrapezoidProfile.State(measuredPosition, measuredVelocity));
  }
  ...
  public void initSendable(SendableBuilder builder) {
    ...
    builder.addDoubleProperty(
        "maxVelocity", () -> getConstraints().maxVelocity.getAsDouble(), null);
    builder.addDoubleProperty(
        "maxAcceleration", () -> getConstraints().maxAcceleration.getAsDouble(), null);
